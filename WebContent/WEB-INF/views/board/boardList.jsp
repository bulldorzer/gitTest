...
<body>
	<form method="get" name="boardPaging" action="/board/boardList.do">
	...
	<form method="get" name=boardSearchForm action="/board/boardList.do">
		<table  align="center">
			<tr>
				<td align="left">
					<a href ="/board/LoginView.do">login</a> &nbsp; / &nbsp; <a href ="/board/JoinView.do">join</a>
				</td>
				<td align="right">
					total : ${totalCnt}
				</td>
						...
						<c:forEach items="${boardList}" var="list">
							<tr>
								...
								<td value="${list.code_id}">
									<a href = "/board/${list.code_id}/${list.boardNum}/boardView.do?pageNo=${pageNo}">${list.boardTitle}</a>
								</td>
							</tr>	
						</c:forEach>
					</table>
